...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 13 00:47:56 2019
...
songplay_table_insert = (""" INSERT INTO songplays(songplay_id, start_time, user_id, level, session_id, location, user_agent, song_id, artist_id) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s) ON CONFLICT (songplay_id) DO NOTHING
""")
